...
from berp_hrms.payroll.doctype.salary_structure.salary_structure import _make_salary_slip
...
class SalaryBreakupReport:
	...
	def get_message(self):
		path = "berp_hrms/payroll/report/employee_ctc_break_up/employee_profile_card.html"
