...
from berp_hrms.payroll.doctype.employee_benefit_claim.employee_benefit_claim import (
...
class EmployeeBenefitApplication(Document):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.payroll.doctype.employee_benefit_application_detail.employee_benefit_application_detail import (
