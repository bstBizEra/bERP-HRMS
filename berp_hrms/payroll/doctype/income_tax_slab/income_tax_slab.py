...
from berp_hrms.hr.utils import calculate_tax_with_marginal_relief
...
class IncomeTaxSlab(Document):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.payroll.doctype.income_tax_slab_other_charges.income_tax_slab_other_charges import (
			IncomeTaxSlabOtherCharges,
		)
		from berp_hrms.payroll.doctype.taxable_salary_slab.taxable_salary_slab import TaxableSalarySlab
