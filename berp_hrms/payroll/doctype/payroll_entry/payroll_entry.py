...
from berp_hrms.payroll.doctype.salary_withholding.salary_withholding import (
	link_bank_entry_in_salary_withholdings,
)
from berp_hrms.utils.holiday_list import (
...
class PayrollEntry(Document):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.payroll.doctype.payroll_employee_detail.payroll_employee_detail import (
	...
	def create_overtime_slips(self) -> None:
		...
		from berp_hrms.hr.doctype.overtime_slip.overtime_slip import (
