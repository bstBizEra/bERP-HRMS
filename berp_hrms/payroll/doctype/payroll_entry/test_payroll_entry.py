...
from berp_hrms.hr.doctype.employee_advance.employee_advance import (
	create_return_through_additional_salary,
)
from berp_hrms.payroll.doctype.payroll_entry.payroll_entry import (
	PayrollEntry,
	get_end_date,
	get_start_end_dates,
	set_match_conditions,
)
from berp_hrms.payroll.doctype.salary_component.test_salary_component import create_salary_component
from berp_hrms.payroll.doctype.salary_slip.salary_slip_loan_utils import if_lending_app_installed
...
from berp_hrms.utils import get_date_range
...
class TestPayrollEntry(HRMSTestSuite):
	...
	def test_get_payroll_entries_for_jv_filters_docstatus(self):
		from berp_hrms.payroll.doctype.payroll_entry.payroll_entry import get_payroll_entries_for_jv
	...
	def test_advance_deduction_in_accrual_journal_entry(self):
		from berp_hrms.hr.doctype.employee_advance.test_employee_advance import (
	...
	def test_validate_attendance_with_holiday_list_assignment(self):
		...
		from berp_hrms.payroll.doctype.salary_slip.test_salary_slip import make_holiday_list
	...
	def test_set_match_conditions_maps_permission_doctype_to_employee_field(self):
		...
		with patch(
			"berp_hrms.payroll.doctype.payroll_entry.payroll_entry.get_match_cond",
