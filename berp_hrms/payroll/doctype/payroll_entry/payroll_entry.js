...
frappe.ui.form.on("Payroll Entry", {
	...
	setup: function (frm) {
		...
		frm.set_query("employee", "employees", () => {
			...
			return {
				query: "berp_hrms.payroll.doctype.payroll_entry.payroll_entry.employee_query",
	...
	set_start_end_dates: function (frm) {
		if (frm.doc.payroll_frequency) {
			frappe.call({
				method: "berp_hrms.payroll.doctype.payroll_entry.payroll_entry.get_start_end_dates",
				args: {
	...
	set_end_date: function (frm) {
		frappe.call({
			method: "berp_hrms.payroll.doctype.payroll_entry.payroll_entry.get_end_date",
			args: {
