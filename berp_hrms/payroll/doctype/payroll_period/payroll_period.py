...
from berp_hrms.hr.utils import get_exact_month_diff, get_holiday_dates_for_employee
...
class PayrollPeriod(Document):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.payroll.doctype.payroll_period_date.payroll_period_date import PayrollPeriodDate
