...
frappe.ui.form.on("Salary Structure", {
	...
	set_earning_deduction_component: function (frm) {
		...
		frm.set_query("salary_component", "earnings", function () {
			return {
				...
				query: "berp_hrms.payroll.doctype.salary_structure.salary_structure.get_salary_component",
			};
		});
	...
	preview_salary_slip: function (frm) {
		frappe.call({
			method: "berp_hrms.payroll.doctype.salary_structure.salary_structure.get_employees",
			args: {
	...
	open_salary_slip: function (frm, employee) {
		...
		frappe.call({
			method: "berp_hrms.payroll.doctype.salary_structure.salary_structure.make_salary_slip",
			args: {
...
frappe.ui.form.on("Salary Detail", {
	form_render: function (frm, cdt, cdn) {
		...
		berp_hrms.payroll_utils.set_autocompletions_for_condition_and_formula(frm, row);
	},
