...
from berp_hrms.payroll.doctype.bulk_salary_structure_assignment.bulk_salary_structure_assignment import (
...
from berp_hrms.tests.test_utils import create_company, create_department, create_employee_grade
