...
from berp_hrms.payroll.utils import COMPONENT_TYPE_TO_PARENTFIELD, sanitize_expression
...
class SalaryComponent(Document):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.payroll.doctype.salary_component_account.salary_component_account import (
