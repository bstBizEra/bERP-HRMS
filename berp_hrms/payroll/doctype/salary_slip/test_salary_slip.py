...
from berp_hrms.hr.doctype.leave_allocation.test_leave_allocation import create_leave_allocation
from berp_hrms.hr.doctype.leave_type.test_leave_type import create_leave_type
from berp_hrms.payroll.doctype.employee_tax_exemption_declaration.test_employee_tax_exemption_declaration import (
	create_exemption_category,
	create_payroll_period,
)
from berp_hrms.payroll.doctype.payroll_entry.payroll_entry import get_month_details
from berp_hrms.payroll.doctype.salary_slip.salary_slip import (
...
from berp_hrms.tests.test_utils import get_email_by_subject, get_first_sunday
...
class TestSalarySlip(HRMSTestSuite):
	...
	def test_payment_days_calculation_for_lwp_on_month_boundaries(self):
		from berp_hrms.hr.doctype.holiday_list_assignment.test_holiday_list_assignment import (
	...
	def test_salary_slip_generation_against_opening_entries_in_ssa(self):
		...
		from berp_hrms.payroll.doctype.payroll_period.payroll_period import get_period_factor
		from berp_hrms.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure
	...
	def test_income_tax_unchanged_on_submit_with_exempted_additional_deduction(self):
		from berp_hrms.payroll.doctype.payroll_entry.test_payroll_entry import make_payroll_entry
		from berp_hrms.payroll.doctype.salary_structure.test_salary_structure import (
			create_salary_structure_assignment,
			make_salary_structure,
		)
		from berp_hrms.tests.test_utils import create_department
	...
	def test_tax_payable_with_tax_relief_and_marginal_relief_limits(self):
		from berp_hrms.payroll.doctype.salary_structure.test_salary_structure import make_salary_structure
		from berp_hrms.regional.india.setup import setup
