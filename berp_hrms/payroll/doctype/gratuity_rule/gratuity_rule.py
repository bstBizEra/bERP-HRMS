...
class GratuityRule(Document):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.payroll.doctype.gratuity_applicable_component.gratuity_applicable_component import (
			GratuityApplicableComponent,
		)
		from berp_hrms.payroll.doctype.gratuity_rule_slab.gratuity_rule_slab import GratuityRuleSlab
