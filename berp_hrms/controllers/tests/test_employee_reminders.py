...
from berp_hrms.controllers.employee_reminders import send_holidays_reminder_in_advance
from berp_hrms.hr.doctype.holiday_list_assignment.test_holiday_list_assignment import (
	create_holiday_list_assignment,
)
from berp_hrms.hr.doctype.hr_settings.hr_settings import set_proceed_with_frequency_change
from berp_hrms.hr.utils import get_holidays_for_employee
...
class TestEmployeeReminders(HRMSTestSuite):
	...
	def test_birthday_reminders(self):
		...
		from berp_hrms.controllers.employee_reminders import (
	...
	def test_work_anniversary_reminder_not_sent_for_0_years(self):
		...
		from berp_hrms.controllers.employee_reminders import get_employees_having_an_event_today
	...
	def test_advance_holiday_reminders_monthly(self):
		from berp_hrms.controllers.employee_reminders import send_reminders_in_advance_monthly
	...
	def test_advance_holiday_reminders_weekly(self):
		from berp_hrms.controllers.employee_reminders import send_reminders_in_advance_weekly
