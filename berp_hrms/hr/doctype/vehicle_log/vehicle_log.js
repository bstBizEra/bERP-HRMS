...
frappe.ui.form.on("Vehicle Log", {
	...
	before_cancel: function (frm) {
		return new Promise((resolve, reject) => {
			frappe.call({
				method: "berp_hrms.hr.doctype.vehicle_log.vehicle_log.get_draft_expense_claim_cancellation_actions",
				args: {
	...
	expense_claim: function (frm) {
		frappe.call({
			method: "berp_hrms.hr.doctype.vehicle_log.vehicle_log.make_expense_claim",
			args: {
