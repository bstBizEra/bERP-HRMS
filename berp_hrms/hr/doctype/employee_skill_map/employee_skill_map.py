...
class EmployeeSkillMap(Document):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.hr.doctype.employee_skill.employee_skill import EmployeeSkill
		from berp_hrms.hr.doctype.employee_training.employee_training import EmployeeTraining
