...
class LeavePolicyAssignment(Document):
	...
	def calculate_leaves_for_passed_period(
		...
		from berp_hrms.hr.utils import get_monthly_earned_leave as get_periodically_earned_leave
		from berp_hrms.hr.utils import get_sub_period_start_and_end
...
def calculate_periods_passed(
	...
	if effective_from:
		from berp_hrms.hr.utils import get_complete_month_count
...
def is_earned_leave_applicable_for_current_period(
	...
	if earned_leave_frequency == "Half-Yearly" and effective_from:
		from berp_hrms.hr.utils import get_half_year_periods
		...
		from berp_hrms.hr.utils import get_semester_end, get_semester_start
