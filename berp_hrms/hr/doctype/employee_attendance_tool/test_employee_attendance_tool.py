...
from berp_hrms.hr.doctype.employee_attendance_tool.employee_attendance_tool import (
...
from berp_hrms.payroll.doctype.salary_slip.test_salary_slip import make_leave_application
from berp_hrms.tests.utils import HRMSTestSuite, make_company_restricted_user
