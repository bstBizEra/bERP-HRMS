...
import berp_hrms
from berp_hrms.api import get_current_employee_info
from berp_hrms.hr.doctype.leave_block_list.leave_block_list import get_applicable_block_dates
from berp_hrms.hr.doctype.leave_ledger_entry.leave_ledger_entry import create_leave_ledger_entry
from berp_hrms.hr.utils import (
...
from berp_hrms.mixins.pwa_notifications import PWANotificationsMixin
from berp_hrms.utils import get_employee_email
from berp_hrms.utils.holiday_list import get_holiday_dates_between_range
...
class LeaveApplication(Document, PWANotificationsMixin):
	...
	def publish_update(self):
		...
		berp_hrms.refetch_resource("berp_hrms:my_leaves", employee_user)
		berp_hrms.refetch_resource("berp_hrms:team_leaves")
