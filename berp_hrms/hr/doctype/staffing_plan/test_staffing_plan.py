...
from berp_hrms.hr.doctype.staffing_plan.staffing_plan import ParentCompanyError, SubsidiaryCompanyError
...
class TestStaffingPlan(HRMSTestSuite):
	...
	def test_staffing_details_from_job_requisition(self):
		from berp_hrms.hr.doctype.job_requisition.test_job_requisition import make_job_requisition
