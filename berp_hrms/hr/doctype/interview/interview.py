...
class Interview(Document):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.hr.doctype.interview_detail.interview_detail import InterviewDetail
	...
	def show_job_applicant_update_dialog(self):
		...
		frappe.msgprint(
			...
			primary_action={
				...
				"server_action": "berp_hrms.hr.doctype.interview.interview.update_job_applicant_status",
