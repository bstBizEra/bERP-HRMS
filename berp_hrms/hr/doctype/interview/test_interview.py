...
from berp_hrms.hr.doctype.interview.interview import (
	DuplicateInterviewRoundError,
	get_feedback,
	get_skill_wise_average_rating,
	update_job_applicant_status,
)
from berp_hrms.hr.doctype.job_applicant.job_applicant import get_interview_details
from berp_hrms.tests.test_utils import create_job_applicant, get_email_by_subject
...
class TestInterview(HRMSTestSuite):
	...
	def test_notification_for_scheduling(self):
		from berp_hrms.hr.doctype.interview.interview import send_interview_reminder
	...
	def test_notification_for_feedback_submission(self):
		from berp_hrms.hr.doctype.interview.interview import send_daily_feedback_reminder
	...
	def test_skill_wise_average_rating(self):
		from berp_hrms.hr.doctype.interview_feedback.test_interview_feedback import create_interview_feedback
