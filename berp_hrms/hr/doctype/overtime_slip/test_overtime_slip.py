...
from berp_hrms.hr.doctype.overtime_type.test_overtime_type import create_overtime_type
from berp_hrms.hr.doctype.shift_type.test_shift_type import make_shift_assignment, setup_shift_type
from berp_hrms.payroll.doctype.salary_slip.test_salary_slip import make_earning_salary_component
...
class TestOvertimeSlip(HRMSTestSuite):
	...
	def test_overtime_slip_creation_via_payroll_entry(self):
		...
		from berp_hrms.payroll.doctype.payroll_entry.payroll_entry import get_start_end_dates
		from berp_hrms.payroll.doctype.payroll_entry.test_payroll_entry import get_payroll_entry
	...
	def test_overtime_slip_creation_via_payroll_entry_mid_month_leaver(self):
		...
		from berp_hrms.hr.doctype.overtime_slip.overtime_slip import create_overtime_slips_for_employees
		from berp_hrms.payroll.doctype.payroll_entry.payroll_entry import get_start_end_dates
		from berp_hrms.payroll.doctype.payroll_entry.test_payroll_entry import get_payroll_entry
