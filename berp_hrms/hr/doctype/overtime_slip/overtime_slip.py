...
from berp_hrms.payroll.doctype.salary_structure_assignment.salary_structure_assignment import (
...
class OvertimeSlip(Document):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.hr.doctype.overtime_details.overtime_details import OvertimeDetails
	...
	def get_holiday_map(self):
		...
		holiday_dates = get_holiday_dates_between_range(
			self.employee, self.start_date, self.end_date, select_weekly_offs=True, as_dict=True
		)
