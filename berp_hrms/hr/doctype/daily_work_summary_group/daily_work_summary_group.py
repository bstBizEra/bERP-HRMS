...
from berp_hrms.hr.doctype.daily_work_summary.daily_work_summary import get_user_emails_from_group
...
class DailyWorkSummaryGroup(Document):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.hr.doctype.daily_work_summary_group_user.daily_work_summary_group_user import (
