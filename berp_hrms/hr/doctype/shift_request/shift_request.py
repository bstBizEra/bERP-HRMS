...
import berp_hrms
from berp_hrms.hr.doctype.shift_assignment.shift_assignment import has_overlapping_timings
from berp_hrms.hr.utils import share_doc_with_approver, validate_active_employee
...
class ShiftRequest(Document, PWANotificationsMixin):
	...
	def publish_update(self):
		...
		berp_hrms.refetch_resource("berp_hrms:my_shift_requests", employee_user)
		berp_hrms.refetch_resource("berp_hrms:team_shift_requests")
