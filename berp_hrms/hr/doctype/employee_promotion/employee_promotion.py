...
from berp_hrms.hr.utils import update_employee_work_history, validate_active_employee
...
class EmployeePromotion(Document):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.hr.doctype.employee_property_history.employee_property_history import (
