...
from berp_hrms.hr.doctype.employee_checkin.employee_checkin import (
...
from berp_hrms.payroll.doctype.salary_slip.test_salary_slip import make_holiday_list, make_leave_application
