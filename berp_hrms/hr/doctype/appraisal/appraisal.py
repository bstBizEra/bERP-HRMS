...
from berp_hrms.hr.doctype.appraisal_cycle.appraisal_cycle import validate_active_appraisal_cycle
from berp_hrms.hr.utils import validate_active_employee
from berp_hrms.mixins.appraisal import AppraisalMixin
from berp_hrms.payroll.utils import sanitize_expression
...
class Appraisal(Document, AppraisalMixin):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.hr.doctype.appraisal_goal.appraisal_goal import AppraisalGoal
		from berp_hrms.hr.doctype.appraisal_kra.appraisal_kra import AppraisalKRA
		from berp_hrms.hr.doctype.employee_feedback_rating.employee_feedback_rating import (
