...
class LeaveBlockList(Document):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.hr.doctype.leave_block_list_allow.leave_block_list_allow import LeaveBlockListAllow
		from berp_hrms.hr.doctype.leave_block_list_date.leave_block_list_date import LeaveBlockListDate
