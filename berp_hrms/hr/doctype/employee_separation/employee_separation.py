...
from berp_hrms.controllers.employee_boarding_controller import EmployeeBoardingController
...
class EmployeeSeparation(EmployeeBoardingController):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.hr.doctype.employee_boarding_activity.employee_boarding_activity import (
