...
from berp_hrms.hr.doctype.full_and_final_statement.full_and_final_statement_loan_utils import (
...
class FullandFinalStatement(Document):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.hr.doctype.full_and_final_asset.full_and_final_asset import FullandFinalAsset
		from berp_hrms.hr.doctype.full_and_final_outstanding_statement.full_and_final_outstanding_statement import (
