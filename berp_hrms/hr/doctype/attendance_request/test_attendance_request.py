...
from berp_hrms.hr.doctype.attendance_request.attendance_request import OverlappingAttendanceRequestError
...
class TestAttendanceRequest(HRMSTestSuite):
	...
	def test_expired_shift_assignment_is_auto_fetched(self):
		...
		from berp_hrms.hr.doctype.shift_assignment.shift_assignment import (
