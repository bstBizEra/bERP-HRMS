...
import berp_hrms
from berp_hrms.hr.utils import validate_active_employee, validate_dates
...
class AttendanceRequest(Document):
	...
	def publish_update(self):
		...
		berp_hrms.refetch_resource("berp_hrms:my_attendance_requests", employee_user)
		berp_hrms.refetch_resource("berp_hrms:team_attendance_requests")
