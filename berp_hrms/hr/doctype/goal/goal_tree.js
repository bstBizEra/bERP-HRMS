...
frappe.treeview_settings["Goal"] = {
	get_tree_nodes: "berp_hrms.hr.doctype.goal.goal.get_children",
	filters: [
		{
			fieldname: "company",
			fieldtype: "Select",
	...
	fields: [
		...
		},
		{
			...
			get_query() {
				return {
					query: "berp_hrms.hr.doctype.appraisal.appraisal.get_kras_for_employee",
					filters: {
	...
	get_tree_root: false,
	add_tree_node: "berp_hrms.hr.doctype.goal.goal.add_tree_node",
...
function update_progress(node, progress) {
	return frappe
		.call({
			method: "berp_hrms.hr.doctype.goal.goal.update_progress",
			args: {
