...
frappe.ui.form.on("Employee Advance", {
	...
	make_deduction_via_additional_salary: function (frm) {
		frappe.call({
			method: "berp_hrms.hr.doctype.employee_advance.employee_advance.create_return_through_additional_salary",
			args: {
				doc: frm.doc,
			},
			callback: function (r) {
	...
	make_expense_claim: function (frm) {
		return frappe.call({
			method: "berp_hrms.hr.doctype.expense_claim.expense_claim.get_expense_claim",
			args: {
	...
	make_return_entry: function (frm) {
		frappe.call({
			method: "berp_hrms.hr.doctype.employee_advance.employee_advance.make_return_entry",
			args: {
	...
	render_employee_advance_return_banner(frm) {
		frappe.call({
			method: "berp_hrms.hr.doctype.employee_advance.employee_advance.get_employee_advance_return",
			args: {
				employee_advance: frm.doc.name,
			},
			error() {
