...
frappe.ui.form.on("Employee Referral", {
	...
	create_job_applicant: function (frm) {
		frappe.call({
			method: "berp_hrms.hr.doctype.employee_referral.employee_referral.create_job_applicant",
			args: {
	...
	create_additional_salary: function (frm) {
		frappe.call({
			method: "berp_hrms.hr.doctype.employee_referral.employee_referral.create_additional_salary",
			args: {
