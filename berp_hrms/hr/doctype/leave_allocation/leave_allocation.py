...
from berp_hrms.hr.doctype.leave_application.leave_application import get_approved_leaves_for_period
from berp_hrms.hr.doctype.leave_ledger_entry.leave_ledger_entry import (
	create_leave_ledger_entry,
	expire_allocation,
	process_expired_allocation,
)
from berp_hrms.hr.utils import create_additional_leave_ledger_entry, get_leave_period, set_employee_name
from berp_hrms.hr.utils import get_monthly_earned_leave as _get_monthly_earned_leave
...
class LeaveAllocation(Document):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.hr.doctype.earned_leave_schedule.earned_leave_schedule import EarnedLeaveSchedule
...
def show_expire_leave_dialog(expired_leaves, leave_type):
	frappe.msgprint(
		...
		primary_action={
			...
			"server_action": "berp_hrms.hr.doctype.leave_allocation.leave_allocation.expire_carried_forward_allocation",
