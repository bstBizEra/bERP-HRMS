...
frappe.ui.form.on("Employee Onboarding", {
			...
			frm.add_custom_button(
				...
				function () {
					frappe.model.open_mapped_doc({
						method: "berp_hrms.hr.doctype.employee_onboarding.employee_onboarding.make_employee",
						frm: frm,
					});
				},
				__("Create"),
	...
	employee_onboarding_template: function (frm) {
		...
		if (frm.doc.employee_onboarding_template) {
			frappe.call({
				method: "berp_hrms.controllers.employee_boarding_controller.get_onboarding_details",
				args: {
