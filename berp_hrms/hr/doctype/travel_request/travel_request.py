...
class TravelRequest(Document):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.hr.doctype.travel_itinerary.travel_itinerary import TravelItinerary
		from berp_hrms.hr.doctype.travel_request_costing.travel_request_costing import TravelRequestCosting
