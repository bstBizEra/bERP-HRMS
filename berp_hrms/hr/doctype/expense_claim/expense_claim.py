...
import berp_hrms
from berp_hrms.hr.utils import set_employee_name, share_doc_with_approver, validate_active_employee
...
class ExpenseClaim(AccountsController, PWANotificationsMixin):
	...
	if TYPE_CHECKING:
		...
		from berp_hrms.hr.doctype.expense_claim_advance.expense_claim_advance import ExpenseClaimAdvance
		from berp_hrms.hr.doctype.expense_claim_detail.expense_claim_detail import ExpenseClaimDetail
		from berp_hrms.hr.doctype.expense_taxes_and_charges.expense_taxes_and_charges import (
	...
	def publish_update(self):
		...
		berp_hrms.refetch_resource("berp_hrms:my_claims", employee_user)
		berp_hrms.refetch_resource("berp_hrms:team_claims")
