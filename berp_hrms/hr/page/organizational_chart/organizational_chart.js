berp_hrms.organizational_chart = berp_hrms.organizational_chart || {};

Object.assign(berp_hrms.organizational_chart, {
...
frappe.pages["organizational-chart"].on_page_load = function (wrapper) {
	...
	$(wrapper).bind("show", () => {
		frappe.require("hierarchy-chart.bundle.js", () => {
			...
			let method =
				"berp_hrms.hr.page.organizational_chart.organizational_chart.get_children";
			const device_type = frappe.is_mobile() ? "mobile" : "desktop";

			if (frappe.is_mobile()) {
				organizational_chart = new berp_hrms.HierarchyChartMobile(
					"Employee",
					wrapper,
					method,
				);
			} else {
				organizational_chart = new berp_hrms.HierarchyChart("Employee", wrapper, method);
			}

			frappe.breadcrumbs.add("HR");
			berp_hrms.organizational_chart.bind_empty_state_handler(
